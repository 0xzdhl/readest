/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 3a0996a4a10f45bb94cb37523ed56d4b)
// Runtime types generated with workerd@1.20260507.1 2026-05-14 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    TRANSLATIONS_KV: KVNamespace;
    ASSETS: Fetcher;
    PNPM_VERSION: '10.28.1';
    PDFJS_BUILD_PATH: string;
    PDFJS_FONTS_PATH: string;
    PDFJS_STYLE_PATH: string;
    VITE_DEFAULT_POSTHOG_URL_BASE64: string;
    VITE_DEFAULT_POSTHOG_KEY_BASE64: string;
    VITE_DEFAULT_SUPABASE_URL_BASE64: string;
    VITE_DEFAULT_SUPABASE_KEY_BASE64: string;
    VITE_STRIPE_PUBLISHABLE_KEY_DEV_BASE64: string;
    VITE_STRIPE_PUBLISHABLE_KEY_BASE64: string;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | 'PDFJS_FONTS_PATH'
      | 'PDFJS_STYLE_PATH'
      | 'VITE_DEFAULT_POSTHOG_URL_BASE64'
      | 'VITE_DEFAULT_POSTHOG_KEY_BASE64'
      | 'VITE_DEFAULT_SUPABASE_URL_BASE64'
      | 'VITE_DEFAULT_SUPABASE_KEY_BASE64'
      | 'VITE_STRIPE_PUBLISHABLE_KEY_DEV_BASE64'
      | 'VITE_STRIPE_PUBLISHABLE_KEY_BASE64'
    >
  > {}
}
