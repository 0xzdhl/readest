...
import type { BookNote, BookSearchConfig, BookSearchResult } from '@/domain/book';
import type { TTSGranularity } from '@/domain/tts';
import type { TTS } from 'foliate-js/tts.js';
import type { LocaleWithTextInfo } from '@/domain/misc';
