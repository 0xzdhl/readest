...
import { Route as STokenRouteImport } from './app/s/$token'
...
const ApiShareTokenRevokeRouteRoute =
  ApiShareTokenRevokeRouteRouteImport.update({
    id: '/revoke',
    path: '/revoke',
...
const ApiShareTokenImportRouteRoute =
  ApiShareTokenImportRouteRouteImport.update({
    id: '/import',
    path: '/import',
    getParentRoute: () => ApiShareTokenRouteRoute,
  } as any)
const ApiShareTokenDownloadRouteRoute =
  ApiShareTokenDownloadRouteRouteImport.update({
    id: '/download',
    path: '/download',
    getParentRoute: () => ApiShareTokenRouteRoute,
  } as any)
...
const ApiShareTokenDownloadConfirmRouteRoute =
  ApiShareTokenDownloadConfirmRouteRouteImport.update({
    id: '/confirm',
    path: '/confirm',
...
const ApiShareTokenDownloadRouteRouteChildren: ApiShareTokenDownloadRouteRouteChildren =
  {
    ApiShareTokenDownloadConfirmRouteRoute:
      ApiShareTokenDownloadConfirmRouteRoute,
  }

const ApiShareTokenDownloadRouteRouteWithChildren =
  ApiShareTokenDownloadRouteRoute._addFileChildren(
    ApiShareTokenDownloadRouteRouteChildren,
  )
...
const ApiShareTokenRouteRouteWithChildren =
  ApiShareTokenRouteRoute._addFileChildren(ApiShareTokenRouteRouteChildren)
