...
/**
 * Owner-only — caller IS the user being charged. Looks up an existing
 * Stripe customer row (RLS-scoped) or creates one in Stripe and persists
 * the mapping, then opens a Checkout session.
 */
